...
st.set_page_config(page_title="AqualQ Analyzer", layout="wide")
st.markdown(
    """
    <style>
    /* Background for the main page */
    .stApp {
        background: #2e3b4e; /* Dark blue for main container */
        color: white; /* White text for main container */
    }

    /* Sidebar styling */
    [data-testid="stSidebar"] {
        background: linear-gradient(90deg, rgba(235,245,255,1) 0%, rgba(200,220,240,1) 50%, rgba(170,200,220,1) 100%);
        color: white; /* White text for the sidebar */
        padding: 20px; /* Add padding around the sidebar */
        border-radius: 10px; /* Rounded corners */
        box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2); /* Box shadow for risen effect */
    }
    [data-testid="stSidebar"] h2, [data-testid="stSidebar"] h3, [data-testid="stSidebar"] p {
        color: white; /* White text for all headings and paragraphs */
    }

    /* Ensure white text for sidebar menu items */
    [data-testid="stSidebar"] .css-1v3fvcr {
        color: white !important; /* Force white text color for menu items */
    }
    </style>
    """,
...
st.header("AqualQ Monitoring using Satellite Imagery and GIS Techniques")
...
with st.sidebar:
    selected = option_menu(
        ...
        styles={
            "container": {
                "padding": "10px",  # Inner padding for the menu
                "background-color": "#2e3b4e",  # Dark blue background for menu container
                "border-radius": "10px",  # Rounded corners for menu container
                "box-shadow": "0px 4px 8px rgba(0, 0, 0, 0.2)",  # Subtle shadow effect
            },
            "icon": {"color": "#AED6F1", "font-size": "20px"},  # Light blue for icon color
            "nav-link": {
                "font-size": "16px",
                "text-align": "left",
                "margin": "0px",
                "--hover-color": "#5DADE2",  # Medium blue on hover
                "color": "white",  # White text for navigation links
            },
            "nav-link-selected": {"background-color": "#85C1E9", "color": "black"},  # Very light blue for selected item with black text
            "menu-title": {"color": "white", "font-weight": "bold", "font-size": "18px"},  # Menu title styling
        },
        default_index=0,
    )
...
if selected == "Project Information":
    ...
    with header_project:
        ...
        introduction_str=""" 
        AqualQ is a crucial aspect of environmental health, impacting ecosystems, human health, and global biodiversity.
        Yet, with rapid urbanization, industrial activity, and climate change, water bodies worldwide face unprecedented contamination
        and degradation. Addressing these challenges requires innovative solutions to monitor, analyze, and improve AqualQ on a global scale.
        """
        ...
        our_solution_str=""" 
        Leveraging the power of deep learning, this project aims to monitor and improve AqualQ through data-driven insights.
        By analyzing multiple parameters, we provide actionable intelligence that can help address AqualQ challenges,
        guide regulatory measures, and promote sustainable management practices globally.
        """
        ...
        the_dat_Srt=""" 
        For our AqualQ monitoring project in the Bhopal region, we collected data from various lakes using satellite imagery and GIS techniques. The lakes
        ...
        To effectively monitor the AqualQ in these lakes, we collected various parameters related to AqualQ, including pH, salinity, turbidity, 
        ...
        to AqualQ and their ability to provide insights into the health of the lakes.
        """
        st.text(the_dat_Srt)
...
if selected =='Insights':
        ...
        st.header("AqualQ Index and Parameters Identification")
        
        str_text_body = """ 
            There are several AqualQ parameters available, but the team has chosen the following 8 important 
        parameters to monitor AqualQ.\n

        1-pH:One of the most crucial indicators of AqualQ is pH. The pH scale determines how basic or acidic a 
        solution is. \n
        ...
        be turbid. AqualQ is typically impacted by suspended sediments, such as clay, dirt, and silt particles, 
        ...
        4- Chlorophyll: A popular indicator of AqualQ and eutrophication level is chlorophyll-a.
        The concentration of phytoplankton is determined by the amount of chlorophyll present in a water sample. 
        Greater concentrations, which often occur when high algal production is sustained, indicate poorer AqualQ.\n
        ...
        str_findings="""
        Our data collection efforts yielded a rich dataset of AqualQ parameters for Lendyia lake in the Bhopal region.
        ...
        Overall, the data provides a comprehensive view of AqualQ in the Bhopal region and can be
        ...
        conlsution = """
        In conclusion, monitoring AqualQ using satellite imagery, GIS techniques, and 
        ...
        which is essential for developing appropriate strategies to address AqualQ 
...
if selected == "Dashboards":
    ...
    st.write("Turbidity vs DOM vs Salinity vs SPM - [link](https://public.tableau.com/app/profile/shubham.shankar6597/viz/TDSS_17312705544390/TurbidityvsDOMvsSalinityvsSPM)")
    ...
    st.write("Dissolved Oxygen - [link](https://public.tableau.com/app/profile/shubham.shankar6597/viz/O2Dissolved/Dashboard3)")
    st.write("Chlorophyll - [link](https://public.tableau.com/app/profile/shubham.shankar6597/viz/Chlorophyll_17312710978950/Dashboard1)")
    st.write("Monsoon Analysis Chlorophyll - [link](https://public.tableau.com/app/profile/shubham.shankar6597/viz/MonsoonAnalysis/MonsoonAnalysisChyllA)")
    st.write("Lendiya Lake (Dissolved Oxygen v Chlorophyll v Turbidity) [link](https://public.tableau.com/app/profile/shubham.shankar6597/viz/LendiyaLake/DrinkingWaterQuality))")
    st.write("Lendiya Lake (Drinking AqualQ) [link](https://public.tableau.com/app/profile/shubham.shankar6597/viz/WQA/DrinkingWaterQuality)")
